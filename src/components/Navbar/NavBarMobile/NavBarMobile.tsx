...
export const NavBarMobile = () => {
  ...
  return (
    <>
      ...
      <div
        className={`absolute bg-background top-[100px] h-[calc(100vh-100px)] w-full transition-all ${
          isCollapsed ? "-left-96 opacity-0" : "left-0 opacity-1"
        }`}
      >
